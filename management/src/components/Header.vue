<template>
  ...
  <div id="tou">
    <el-row>
      <el-col :span="12"><div style="background-color: #0d5ab1">
        <el-image
          style="width: 220px; height: 80px;margin-left: 50px"
          :src="require('C:\\Users\\Jarvis2K\\Desktop\\小学期2\\Workspace\\management\\src\\resource\\shdt.png')"
          :fit="container"
      ></el-image></div></el-col>
      <el-col :span="12">
        <div >
